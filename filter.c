...
////////////////////////////////////////////////////////////////////////////////
/* 入力のフローを生成しているuserが, ブラックリストに登録されているか探す関数 */
////////////////////////////////////////////////////////////////////////////////
...
//////////////////////////////////////////////////////////////////////////
/* 登録されたフローの構成パケット数が閾値を超えたかどうかを判定する関数 */
//////////////////////////////////////////////////////////////////////////
...
//////////////////////////////////////////////////////////////////////
/* ブラックリストに登録されたuserが生成しているフローとの比較を行う */
//////////////////////////////////////////////////////////////////////
...
int removeFlow( sent_flow_t * remove_node, user_list_t * user_node )
{
	...
	{
		// このとき, userが生成したフローが削除される
		// userをブラックリストから削除する必要がある
